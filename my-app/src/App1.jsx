    ...
    <div className="container mx-auto p-6">
      ...
      <div className="flex flex-col space-y-2">
        ...
        <button
          ...
          className="bg-blue-500  p-2 rounded-lg hover:bg-blue-700"
        >
      ...
      <div className="mt-4 space-x-2">
        <button onClick={() => dispatch({ type: "+" })} className="bg-red-500  p-2 rounded-lg">
          Tăng
        </button>
        <button onClick={() => dispatch({ type: "-" })} className="bg-blue-500  p-2 rounded-lg">
          Giảm
        </button>
      </div>
      ...
      <div className="mt-4">
        ...
        <button onClick={handleClick} className="bg-green-500  p-2 rounded-lg ml-2">
          In
        </button>
        <span className="block text-lg font-bold mt-2">{name}</span>
      </div>
    </div>
  );
}
        ...
        {data.map((item) => (
          <tr key={item.id} className="border-b">
            ...
            <td className="p-2 space-x-2">
              ...
              <button onClick={() => onDelete(item)} className="bg-red-100  p-1 rounded-lg">
                Delete
              </button>
            </td>
          </tr>
